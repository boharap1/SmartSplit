...
class _GroupDetailsScreenState extends State<GroupDetailsScreen>
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      context.read<ExpenseProvider>().startListeningToExpenses(widget.groupId);
    });
  }
          ...
          child: Row(
            children: [
              Container(
                ...
                child:
                    const Icon(Icons.receipt, color: AppConstants.primaryColor),
              ),
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  const SizedBox(height: 8),
                  Text(
                    '£${expenseProvider.totalGroupExpenses.toStringAsFixed(2)}',
                    style: const TextStyle(
                        color: Colors.white,
                        fontSize: 32,
                        fontWeight: FontWeight.bold),
              ...
              Row(
                ...
                children: [
                  ...
                  IconButton(
                    ...
                    icon:
                        const Icon(Icons.copy, color: AppConstants.primaryColor),
                  ),
                ],
              ),
            ],
